...
import { TextField, Button, FormControlLabel, Select, MenuItem, Switch,   useTheme, useMediaQuery } from '@mui/material';
...
const OrganizationInformationForm = () => {
  const handleSubmit = (event) => {
    event.preventDefault();
    console.log('Organization Information Form submitted!');
    // Add logic to handle form submission for organizational information
  };

  return (
    <form onSubmit={handleSubmit}>
      {/* Add fields for organizational information */}
...
const RegistrationForm = () => {
  ...
  const handleOrganizationInfoClick = () => {
    ...
    <div className="flex flex-col items-center justify-center p-4">
      <div className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        ...
        <div className="flex items gap-3 mt-0">
          ...
          <CustomButton variant="outlined" onClick={handlePersonalInfoClick}>
            <IconLockContainer>
        ...
        <div className="flex items-center justify-between my-10">
          <CustomButton variant="outlined" onClick={handleOrganizationInfoClick}>
            <IconLockContainer>
        ...
        {showPersonalInfoForm ? <PersonalInformationForm /> : <OrganizationInformationForm />}
      </div>
    </div>
  );
};
